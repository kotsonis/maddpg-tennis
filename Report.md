...
* Given a random state s' ∈ S and reward r ∈ R the probability of s' and r occuring at time t given a preceding state s and action a is given by the four argument MDP <strong>dynamics function</strong> (<math xmlns='http://www.w3.org/1998/Math/MathML'><semantics>p:S&#x00D7;R&#x00D7;S&#x00D7;A&#x2192;[0,1])

  * p(s&#x0027;,r&#x007C;s,a)&#x2250;Pr&#x007B;S<sub>t</sub>=s&#x0027;,R<sub>t</sub>=r&#x007C;S<sub>t+1</sub>=s,A<sub>t&#x2212;1</sub>=a&#x007D;
    * &#x2200;s&#x0027;,s&#x2208;S,r&#x2208;R,a&#x2208;A(s)</semantics></math>
